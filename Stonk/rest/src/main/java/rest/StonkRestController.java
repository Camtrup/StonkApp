...
public class StonkRestController {
  ...
  public String buyStonks(@PathVariable String username, @PathVariable String password,
  ...
  public String sellStonks(@PathVariable String username, @PathVariable String password,
      @PathVariable String ticker,
      @PathVariable int count) {
  ...
  public String addStonksToWatchList(@PathVariable String username, @PathVariable String password,
      @PathVariable String ticker) {
  ...
  public String removeStonksToWatchList(@PathVariable String username,
  ...
  public String newUser(@PathVariable String firstname, @PathVariable String lastname,
      @PathVariable String username,
      @PathVariable String password, @PathVariable Float cash, @PathVariable int age) {
  ...
  public String addMoreValue(@PathVariable String username,
      @PathVariable String password, @PathVariable Float cash) {
